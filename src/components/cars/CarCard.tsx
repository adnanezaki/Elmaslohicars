...
export default function CarCard({ car, priority = false }: CarCardProps) {
  ...
  const totalPrice = car.pricePerDay * diffInDays;
  ...
  }, [t, car.name, startDate, endDate, diffInDays, totalPrice]);
      ...
      <div className="flex flex-col flex-1 p-7 gap-6">
        ...
        <div className="pt-1">
          <DateRangePicker
            ...
            onStartChange={(d) => {
              setStartDate(d);
              // Keep end date at least 1 day after start
              const s = new Date(d);
        ...
        <div className="flex items-end justify-between pt-1">
          <div>
            ...
            <div className="flex items-baseline gap-1.5">
              <span className="text-4xl font-black text-[#0A142F] leading-none">{totalPrice}</span>
          ...
          <div className="bg-[#C8922A]/8 border border-[#C8922A]/20 rounded-2xl px-5 py-3 flex flex-col items-center">
            <span className="text-2xl font-black text-[#C8922A] leading-none">{diffInDays}</span>
        ...
        <button
          ...
          className="w-full bg-[#0A142F] text-white py-4 rounded-xl font-black uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-[#C8922A] transition-all duration-300 active:scale-[0.98] shadow-xl shadow-[#0A142F]/10 group/btn"
        >
